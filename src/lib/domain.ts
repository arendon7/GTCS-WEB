...
export type ReceptionRecord = { id:string; plantId:string; plant:string; generator:string; route:string; wasteType:WasteType; netWeightKg:number; rejectionKg:number; rejectionKnown?:boolean; acceptance:AcceptanceStatus; observation?:string; startedAt:string; endedAt:string; lotCode:string; source:"demo"|"local"|"historical"; timePrecision?:"datetime"|"date_only"; provenance?:HistoricalProvenance };
