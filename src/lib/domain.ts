...
export type PhysicalLotStatus = "available" | "quarantined" | "in_process" | "depleted";
...
export type ReceptionPhysicalLot = { id:string; initialMassKg:number; availableMassKg:number; status:PhysicalLotStatus };
