...
export default function DeficiencyGuidePage() {
  ...
  return (
    <>
      <ArticleJsonLd
        headline="Guía práctica para identificar deficiencias nutricionales"
        description="Diagnóstico visual inicial para aguacate, cacao, café, pastos y limón Tahití."
        url={url}
        dateModified="2026-04-22"
        about={["Nutrición vegetal", "Aguacate", "Cacao", "Café", "Pastos", "Limón Tahití"]}
      />
      ...
      <section className="knowledge-section knowledge-section--soft">
        <div className="container">
          <div className="section-heading"><span className="eyebrow">Por cultivo</span><h2>La misma deficiencia no se lee igual en todos los sistemas.</h2><p>Usa el tejido donde inicia el síntoma, su patrón y el contexto productivo como primer filtro.</p></div>
              ...
              <article className="deficiency-crop" key={crop.slug} id={crop.slug}>
                ...
                <div className="deficiency-table-wrap">
                  <table className="deficiency-table">
                    <thead><tr><th>Nutriente</th><th>Dónde inicia</th><th>Síntoma guía</th><th>Clave de interpretación</th></tr></thead>
      ...
      <section className="knowledge-source-band">
        <div className="container knowledge-source-grid"><div><span className="eyebrow eyebrow--light">Fuente y gobernanza</span><h2>Diagnóstico primero. Producto después.</h2></div><div><p>Esta versión web deriva de la guía técnica consolidada por Greenatics. Las recomendaciones específicas, dosis, mezclas y correcciones requieren validación técnica del lote y documentación vigente del producto.</p><Link href="/diagnostico/">Iniciar diagnóstico Greenatics →</Link></div></div>
      </section>
    </>
  );
}
