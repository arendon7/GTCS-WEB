      ...
      <section className="municipal-hero municipal-hero--depth">
        <div className="container municipal-grid">
          <div>
            ...
            <div className="button-row"><Link className="button button--light" href="/contacto/">Solicitar diagnóstico territorial</Link><Link className="button button--outline-light" href="/servicios/">Ver portafolio completo</Link></div>
          </div>
