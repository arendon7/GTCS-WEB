...
const kits = [
  ...
  { slug: "casa-completa", name: "Casa Completa", audience: "Hogares con plantas en etapas distintas", composition: "4 líneas Wondergreen · orientación 500 g", promise: "Muchas plantas pueden compartir una lógica, pero cada una entra por su momento.", image: "/kits/kit-casa-completa-v1.png" },
    ...
    <div className="homegarden-public-subpage">
      <section className="homegarden-subpage-hero">
        <div className="container homegarden-subpage-hero__grid">
          ...
          <figure className="homegarden-subpage-hero__visual homegarden-subpage-hero__visual--kits"><Image src="/kits/kit-casa-completa-v1.png" alt="Guía visual del Kit Wondergreen Casa Completa" fill priority sizes="(max-width: 850px) 100vw, 40vw" /><figcaption>RUTA DE CUIDADO · COTIZACIÓN ACOMPAÑADA</figcaption></figure>
        </div>
      </section>
