...
const queue = [
  ["QA-108", "Pesaje jornada 04", "R-02 · 06 jun", "Unidad por confirmar", "Claudia C.", "Corrección", "warn"],
...
const findings = [
  ...
  ["H-014", "Capacidad de recepción por confirmar", "Infraestructura", "Alta", "EV-199 · P-03", "Con decisión", "warn"],
...
const evidence = [
  ...
  ["EV-218", "Planilla de pesaje jornada 04", "R-02 · QA/QC", "10 jun 2026", "Documento · 3 registros", "Pendiente de unidad", "warn"],
