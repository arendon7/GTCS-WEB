...
export default function CompaniesPage() {
  return (
    <>
      <section className="solution-hero solution-hero--dark company-hero--depth">
        <div className="container solution-hero-grid">
          <div>
            ...
            <div className="button-row"><Link className="button button--light" href="/contacto/?servicio=diagnostico-caracterizacion">Solicitar diagnóstico</Link><Link className="button button--outline-light" href="/servicios/">Ver servicios</Link></div>
          </div>
      ...
      <section className="closing-cta"><div className="container closing-inner"><div><span className="eyebrow">Primer paso</span><h2>Muéstranos dónde nace el residuo y construimos la ruta desde ahí.</h2></div><Link className="button button--dark" href="/contacto/?servicio=diagnostico-caracterizacion">Hablar con Greenatics</Link></div></section>
    </>
  );
}
