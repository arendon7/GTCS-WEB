...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="es"><body><OpsStoreProvider><MaintenanceStoreProvider><CompostStoreProvider><InventoryStoreProvider>{children}</InventoryStoreProvider></CompostStoreProvider></MaintenanceStoreProvider></OpsStoreProvider></body></html>;
}
