...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="es"><body><OpsStoreProvider><MaintenanceStoreProvider><CompostStoreProvider><InventoryStoreProvider><CommercialStoreProvider>{children}</CommercialStoreProvider></InventoryStoreProvider></CompostStoreProvider></MaintenanceStoreProvider></OpsStoreProvider></body></html>;
}
