...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="es"><body><OpsStoreProvider><MaintenanceStoreProvider><CompostStoreProvider><InventoryStoreProvider><CommercialStoreProvider><ExpenseStoreProvider><SupplyStoreProvider><PurchaseRequestStoreProvider><SettlementStoreProvider>{children}</SettlementStoreProvider></PurchaseRequestStoreProvider></SupplyStoreProvider></ExpenseStoreProvider></CommercialStoreProvider></InventoryStoreProvider></CompostStoreProvider></MaintenanceStoreProvider></OpsStoreProvider></body></html>;
}
