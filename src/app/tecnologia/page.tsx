...
export default function TechnologyPage() {
  return (
    <>
      ...
      <section className="science-section"><div className="container science-grid"><div><span className="eyebrow eyebrow--light">Ciencia aplicada</span><h2>Greenatics articula empresa, territorio y conocimiento académico.</h2><p>Parte del desarrollo tecnológico de los sistemas FORSU se ha realizado con acompañamiento y trabajo conjunto del Grupo Interdisciplinario de Estudios Moleculares —GIEM— de la Universidad de Antioquia.</p></div><div className="science-facts"><article><span>1992</span><strong>Trayectoria GIEM</strong><p>La Universidad de Antioquia reporta la creación del GIEM en 1992 y líneas de investigación básica y aplicada en sectores agrícola, biotecnológico e industrial.</p></article><article><span>A1</span><strong>Reconocimiento en investigación</strong><p>La documentación del proyecto Greenatics–UdeA registra al GIEM como grupo reconocido categoría A1 en la Convocatoria Nacional 894 de 2021 del SNCTeI.</p></article><article><span>ICA</span><strong>Capacidad analítica</strong><p>El proyecto documenta al GIEM como laboratorio avalado por el ICA para control de calidad de fertilizantes, acondicionadores de suelo y/o reguladores fisiológicos.</p></article><article><span>COL0007462</span><strong>Identificación del grupo</strong><p>El GIEM aparece identificado en los registros institucionales de investigación de la Universidad de Antioquia y del sistema nacional de ciencia y tecnología.</p></article></div></div></section>
