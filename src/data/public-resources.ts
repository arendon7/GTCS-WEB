...
export const publicResources: PublicResource[] = [
  ...
  { id: "wondergreen-more-than-npk", kind: "technology", statusLabel: "Tecnología", title: "Más que NPK", copy: "Matriz orgánica, formulación, oclusión y peletizado explicados desde la arquitectura técnica del sistema Wondergreen.", href: "/wondergreen#tecnologia", cta: "Entender la tecnología", delivery: "web-native", sourceAuthority: "Wondergreen Product Truth" },
