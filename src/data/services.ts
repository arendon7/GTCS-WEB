...
export const services: GreenaticsService[] = [
  ...
  },
  {
    ...
    summary: "Llevamos la planeación de residuos hacia decisiones implementables de separación, recolección selectiva, aprovechamiento e indicadores.",
  ...
  },
  {
    ...
    solves: "Reduce el riesgo de comprar una tecnología sin haber validado generación, suministro, localización, logística, salidas de producto y modelo operativo.",
    includes: ["demanda y oferta de residuos", "alternativas tecnológicas", "dimensionamiento preliminar", "implantación y servicios requeridos", "modelo operativo", "CAPEX/OPEX de orden preliminar", "riesgos y ruta de maduración"],
  ...
  },
  {
    ...
    includes: ["balances de masa", "ingeniería de proceso", "dimensionamiento de equipos", "implantación", "APU y cantidades de obra según alcance", "servicios auxiliares", "seguridad y operación", "documentación para estructuración pública cuando aplique"],
    deliverables: ["memorias y planos según contrato", "presupuesto y APU", "especificaciones", "manuales o bases operativas", "cronograma de implementación"],
  ...
  },
  {
    ...
    category: "Recolección",
    audience: "Ambos",
    summary: "Herramienta de implementación para probar, estabilizar o ampliar microrrutas de orgánicos en escalas territoriales y empresariales.",
...
export const environmentalParkModules = [
  ...
  ["Recolección selectiva", "Rutas, microrrutas, motocarguero y datos desde el origen."],
  ...
  ["Biogás y energía", "Recuperación energética cuando el balance técnico y económico del proyecto lo justifica."],
  ["Formación y demostración", "Espacios de capacitación, transferencia de conocimiento y apropiación territorial."],
