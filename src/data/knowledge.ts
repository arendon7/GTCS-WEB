...
export const homeKitFamilies = [
  { name: "Follaje y crecimiento", use: "Materas, jardín y plantas cuyo objetivo dominante es desarrollo vegetativo.", state: "Ruta de cuidado para crecimiento, brotación y recuperación vegetativa." },
  { name: "Floración y producción en matera", use: "Plantas ornamentales o productivas manejadas en espacios pequeños y contenedores.", state: "Ruta por etapa reproductiva, con selección guiada por especie y condición de la planta." },
  { name: "Huerta urbana y aromáticas", use: "Huertas caseras, escolares o comunitarias y sistemas de aromáticas de pequeña escala.", state: "Ruta que prioriza Compost, suelo vivo y nutrición por etapa sin receta rígida." },
  { name: "Rescate y mantenimiento", use: "Plantas que requieren recuperar condición general o sostener un manejo doméstico ordenado.", state: "Ruta de observación, ajuste de condiciones y mantenimiento continuo." },
] as const;
