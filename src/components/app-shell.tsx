...
const nav = [["Hoy", "/"], ["Calendario", "/calendar"], ["Recepciones", "/receptions"], ["Compostaje", "/compost"], ["Equipos", "/equipment"], ["Dashboard", "/dashboard"], ["Registrar actividad", "/activities/new"], ["Alertas", "/#alertas"]] as const;
