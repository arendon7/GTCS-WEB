...
const nav = [["Hoy", "/"], ["Calendario", "/calendar"], ["Recepciones", "/receptions"], ["Compostaje", "/compost"], ["Equipos", "/equipment"], ["Registrar actividad", "/activities/new"], ["Alertas", "/#alertas"], ["Dashboard", "/#dashboard"]] as const;
