...
export function EquipmentDetail({ equipmentId }: { equipmentId: string }) {
  ...
  const close = async () => {
    ...
    setFeedback("");
    try {
      const result = await closeTicket(active.id, { cause, resolution });
