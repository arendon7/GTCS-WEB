...
export function CompostList() {
  ...
  return <>
    <header className="page-header"><div><p className="eyebrow">Proceso productivo</p><h1>Compostaje</h1><p className="lede">Pilas, controles técnicos y trazabilidad desde los lotes de recepción.</p></div><div className="header-actions"><Link className="button secondary" href="/">Volver a hoy</Link>{canWrite?<Link className="button primary" href="/compost/new">Nueva pila</Link>:<span className="quiet">Solo lectura</span>}</div></header>
