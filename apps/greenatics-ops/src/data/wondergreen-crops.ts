...
export const wondergreenCrops: WondergreenCrop[] = [
  {
    slug: "cacao",
    name: "Cacao",
...
export function getWondergreenCrop(slug: string) {
  return wondergreenCrops.find((crop) => crop.slug === slug);
}
