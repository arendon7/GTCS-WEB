    ...
    return (
      <>
        ...
        <div className={styles.mobileActions}>
          <a className={styles.mobileGreenatics} href={greenaticsPublicUrl} onClick={closeMobile}>Volver a Greenatics</a>
  ...
  return (
    <header className={styles.header}>
      <div className={styles.headerInner}>
        <a className={styles.brand} href={greenaticsPublicUrl} aria-label="Volver a Greenatics">
        ...
        <div className={styles.actions}>
          <a className={styles.greenaticsReturn} href={greenaticsPublicUrl}>Volver a Greenatics</a>
