...
const routes = [
  ["home", "/"],
  ["servicios", "/servicios/"],
  ["servicio-pgirs", "/servicios/pgirs-pmirs/"],
  ["servicio-motocarguero", "/servicios/microrrutas-motocarguero/"],
  ...
  ["producto-2grow", "/wondergreen/productos/2grow/"],
  ["producto-2balance", "/wondergreen/productos/2balance/"],
