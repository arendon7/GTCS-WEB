...
## Activos de producto digital · Calcula tu Huella

Las capturas funcionales de la experiencia vigente se copiaron desde:
`apps/calcula-tu-huella/docs/visual/` y el paquete local de pantallas de `CalculaTuHuella/current/site/assets/screenshots/`.

| Activo público | Estado visual | Uso permitido |
| --- | --- | --- |
| `public/tools/huella/dashboard.png` | `REFERENCE_ONLY` | Mostrar el centro de trabajo y su relación con avance, hallazgos y revisión. |
| `public/tools/huella/recorrido.png` | `REFERENCE_ONLY` | Explicar las seis etapas del inventario sin presentarlo como entorno activo. |
| `public/tools/huella/diccionario.png` | `REFERENCE_ONLY` | Mostrar ayudas de lenguaje claro y captura guiada. |

Estos activos no son evidencia de resultados de un cliente. Las cifras, nombres y estados visibles son demostrativos y deben conservar esa leyenda cuando aparezcan en la web pública.
